...
class MovieItem{
  late int id;
  late String imagePath,backdrop_path,title,description,date,original_language;
  late double rate;
  late bool adult;
  ...
  Future<void> Recommend()async{
    Response recommendations=await Dio().get("https://api.themoviedb.org/3/movie/$id/recommendations?api_key=fadb5d6a867181fbfa820bf958696c92");
  ...
  {
    Response credits=await Dio().get("https://api.themoviedb.org/3/movie/$id/credits?api_key=fadb5d6a867181fbfa820bf958696c92");
...
class MoviesData{
  ...
  MoviesData(Map<String,dynamic>Now,Map<String,dynamic>Upcoming,Map<String,dynamic>TopRated,Map<String,dynamic>Popular)
  {
    movieList(Now, "Now");
