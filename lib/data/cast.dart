...
class Cast{
  ...
  {
    Response response =await Dio().get("https://api.themoviedb.org/3/person/$id?api_key=fadb5d6a867181fbfa820bf958696c92");
    Response responseImage =await Dio().get("https://api.themoviedb.org/3/person/$id/images?api_key=fadb5d6a867181fbfa820bf958696c92");
  ...
  {
    Response response =await Dio().get("https://api.themoviedb.org/3/person/$id/movie_credits?api_key=fadb5d6a867181fbfa820bf958696c92");
    var castMovies=response.data["cast"]as List;
    movies= List.from(castMovies.map((e) => MovieItem.fromApi(e)));
  }
